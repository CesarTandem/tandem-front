...
// Rutas de las páginas (relativas a la raíz)
const RUTAS = {
    inicio: '/inicio/inicio.html',
    infancia: '/infancia/infancia.html',
    juventud: '/juventud/juventud.html',
    mayores: '/mayores/mayores.html',
    contacto: '/contacto/contacto.html',
    nosotros: '/quienes-somos/quienes-somos.html',
    cookies: '/cookies/cookies.html',
    'canal-etico': '/canal-etico/canal-etico.html',
